...
import localexam.template.metrics.List1Page;
 ...
 */
public class List1PDFFileGenerator extends ListPDFFileGenerator {

    private List1Page metrics;
    private int i;

    public List1PDFFileGenerator() {
        super("/localexam/template/resources/LIST1_TEMPLATE.pdf");
        metrics = null;
    }
